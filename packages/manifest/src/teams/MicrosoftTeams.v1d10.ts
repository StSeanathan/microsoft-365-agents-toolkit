// To parse this data:
//
//   import { Convert, MicrosoftTeamsV1D10 } from "./file";
//
//   const microsoftTeamsV1D10 = Convert.toMicrosoftTeamsV1D10(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface MicrosoftTeamsV1D10 {
    $schema?: string;
    /**
...
export class Convert {
    public static toMicrosoftTeamsV1D10(json: string): MicrosoftTeamsV1D10 {
        return cast(JSON.parse(json), r("MicrosoftTeamsV1D10"));
    }

    public static microsoftTeamsV1D10ToJson(value: MicrosoftTeamsV1D10): string {
        return JSON.stringify(uncast(value, r("MicrosoftTeamsV1D10")), null, 2);
    }
}
