// To parse this data:
//
//   import { Convert, MicrosoftTeamsV1D20 } from "./file";
//
//   const microsoftTeamsV1D20 = Convert.toMicrosoftTeamsV1D20(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface MicrosoftTeamsV1D20 {
    $schema?: string;
    /**
     ...
     */
    authorization?: MicrosoftTeamsV1D20Authorization;
    /**
 ...
 * Specify and consolidates authorization related information for the App.
 */
export interface MicrosoftTeamsV1D20Authorization {
    /**
...
export class Convert {
    public static toMicrosoftTeamsV1D20(json: string): MicrosoftTeamsV1D20 {
        return cast(JSON.parse(json), r("MicrosoftTeamsV1D20"));
    }

    public static microsoftTeamsV1D20ToJson(value: MicrosoftTeamsV1D20): string {
        return JSON.stringify(uncast(value, r("MicrosoftTeamsV1D20")), null, 2);
    }
}
...
const typeMap: any = {
    "MicrosoftTeamsV1D20": o([
        { json: "$schema", js: "$schema", typ: u(undefined, "") },
        { json: "accentColor", js: "accentColor", typ: "" },
        { json: "activities", js: "activities", typ: u(undefined, r("Activities")) },
        { json: "authorization", js: "authorization", typ: u(undefined, r("MicrosoftTeamsV1D20Authorization")) },
    ...
    "MicrosoftTeamsV1D20Authorization": o([
