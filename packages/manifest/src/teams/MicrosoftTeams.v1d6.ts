// To parse this data:
//
//   import { Convert, MicrosoftTeamsV1D6 } from "./file";
//
//   const microsoftTeamsV1D6 = Convert.toMicrosoftTeamsV1D6(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface MicrosoftTeamsV1D6 {
    $schema?: string;
    /**
...
export class Convert {
    public static toMicrosoftTeamsV1D6(json: string): MicrosoftTeamsV1D6 {
        return cast(JSON.parse(json), r("MicrosoftTeamsV1D6"));
    }

    public static microsoftTeamsV1D6ToJson(value: MicrosoftTeamsV1D6): string {
        return JSON.stringify(uncast(value, r("MicrosoftTeamsV1D6")), null, 2);
    }
}
