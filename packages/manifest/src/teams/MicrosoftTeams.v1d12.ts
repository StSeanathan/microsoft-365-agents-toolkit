// To parse this data:
//
//   import { Convert, MicrosoftTeamsV1D12 } from "./file";
//
//   const microsoftTeamsV1D12 = Convert.toMicrosoftTeamsV1D12(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface MicrosoftTeamsV1D12 {
    $schema?: string;
    /**
...
export class Convert {
    public static toMicrosoftTeamsV1D12(json: string): MicrosoftTeamsV1D12 {
        return cast(JSON.parse(json), r("MicrosoftTeamsV1D12"));
    }

    public static microsoftTeamsV1D12ToJson(value: MicrosoftTeamsV1D12): string {
        return JSON.stringify(uncast(value, r("MicrosoftTeamsV1D12")), null, 2);
    }
}
