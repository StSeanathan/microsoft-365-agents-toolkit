// To parse this data:
//
//   import { Convert, MicrosoftTeamsV1D16 } from "./file";
//
//   const microsoftTeamsV1D16 = Convert.toMicrosoftTeamsV1D16(json);
//
...
export class Convert {
    public static toMicrosoftTeamsV1D16(json: string): MicrosoftTeamsV1D16 {
        return cast(JSON.parse(json), r("MicrosoftTeamsV1D16"));
    }

    public static microsoftTeamsV1D16ToJson(value: MicrosoftTeamsV1D16): string {
        return JSON.stringify(uncast(value, r("MicrosoftTeamsV1D16")), null, 2);
    }
}
